<template>
	<view class="container">
		...
		<view class="tui-tabbar">
			...
			<view>
				<tui-button width="200rpx" height="70rpx" :size="30" type="danger" shape="circle" :disabled="!hasLogin||totalPrice==0"
				 v-if="!isEdit" @click="btnPay">去结算({{$returnFloat(totalPrice)}})</tui-button>
