...
var _shopcart = _interopRequireDefault(__webpack_require__(/*! ./pages/extend-view/shopcart/shopcart.vue */ 80));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _shopcart_vue_vue_type_template_id_a6e636cc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shopcart.vue?vue&type=template&id=a6e636cc& */ 81);
...
/* harmony import */ var _shopcart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shopcart.vue?vue&type=style&index=0&lang=css& */ 85);
...
//
//
var tuiSwipeAction = function tuiSwipeAction() {return __webpack_require__.e(/*! import() | components/swipe-action/swipe-action */ "components/swipe-action/swipe-action").then(__webpack_require__.bind(null, /*! @/components/swipe-action/swipe-action */ 269));};var tuiButton = function tuiButton() {return __webpack_require__.e(/*! import() | components/extend/button/button */ "components/extend/button/button").then(__webpack_require__.bind(null, /*! @/components/extend/button/button */ 220));};var tuiNumberbox = function tuiNumberbox() {return __webpack_require__.e(/*! import() | components/numberbox/numberbox */ "components/numberbox/numberbox").then(__webpack_require__.bind(null, /*! @/components/numberbox/numberbox */ 262));};var tuiIcon = function tuiIcon() {return __webpack_require__.e(/*! import() | components/icon/icon */ "components/icon/icon").then(__webpack_require__.bind(null, /*! @/components/icon/icon */ 185));};var tuiDivider = function tuiDivider() {return __webpack_require__.e(/*! import() | components/divider/divider */ "components/divider/divider").then(__webpack_require__.bind(null, /*! @/components/divider/divider */ 276));};var tuiLoadmore = function tuiLoadmore() {return __webpack_require__.e(/*! import() | components/loadmore/loadmore */ "components/loadmore/loadmore").then(__webpack_require__.bind(null, /*! @/components/loadmore/loadmore */ 199));};var _default = { components: { tuiSwipeAction: tuiSwipeAction, tuiButton: tuiButton, tuiNumberbox: tuiNumberbox, tuiIcon: tuiIcon, tuiDivider: tuiDivider, tuiLoadmore: tuiLoadmore }, data: function data() {return { basePath: _index.basePath, actions: [{ name: '收藏', width: 64, color: '#fff', fontsize: 28, background: '#FFC600' }, { name: '看相似', color: '#fff', fontsize: 28, width: 64, background: '#FF7035' }, { name: '删除', color: '#fff', fontsize: 28, width: 64, background: '#F82400' }], isEdit: false, productList: [], pageIndex: 1, loadding: false, pullUpOn: true, allchecked: false, //全选默认false
