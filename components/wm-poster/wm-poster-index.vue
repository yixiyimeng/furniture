<template>
	<view style="padding-top: 40upx; background: rgba(0,0,0,.1); height: 100%; position: relative;">
		...
		<view v-if="tempFilePath" style="margin: 30upx 15%;"><button style="background-color: #4A5061; color: #FFFFFF;" @tap="toSaveImage">保存到相册</button></view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			async OnCanvas() {
				...
				let _strHeight = r[1] + 10; //绘制字体距离canvas顶部的初始高度
				let _num = 1;
