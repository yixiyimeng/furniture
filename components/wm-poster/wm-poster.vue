<template>
	<view style="margin-top: 40upx;">
		<canvas :canvas-id="CanvasID" :style="{ width: canvasW + 'px', height: canvasH + 'px' }" style="margin: 0 auto;"></canvas>
		<view v-if="tempFilePath" style="margin: 0 32upx;"><button style="background-color: #4A5061; color: #FFFFFF;" @tap="toSaveImage">保存到相册</button></view>
	</view>
</template>
